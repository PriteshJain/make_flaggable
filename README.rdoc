...
Special thanks to medihack[https://github.com/medihack/make_flaggable] for providing this awesome gem! and 
cavneb[git://github.com/cavneb/make_flaggable.git] for porting it to rails 3.2

== Installation

add MakeFlaggable to your Gemfile

  gem 'make_flaggable', :git => 'git://github.com/PriteshJain/make_flaggable.git'
...
== Usage
  ...
  # Method signature 
  # flagger.flag!(flaggable,flag_name,message=nil)
  ...
  # Add a custom mesaage with the flag! for more verbose details
  user.flag!(article, :flag_name,'why was this object flaggged')
